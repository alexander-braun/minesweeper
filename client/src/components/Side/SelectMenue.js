...
function SelectMenue(props) {
  ...
  return (
    <SelectMenueWrapper>
      ...
      <SelectButton onClick={() => props.toggleModal(!props.modal)}>
        Survivors
      </SelectButton>
      ...
      <a
        href='https://github.com/alexander-braun/coronasweeper'
        target='blank'
        style={{ color: 'white' }}
        id='github_icon'
      >
...
export default React.memo(
  connect(mapStateToProps, mapActionsToProps)(SelectMenue)
);
